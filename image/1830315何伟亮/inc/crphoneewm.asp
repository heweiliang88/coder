 <span style="position:relative;z-index:100">¡¡<div id="qrcodeyl" style="position:absolute;top:30px;z-index:100;left:-90px;display:none;border:5px solid #fff;padding:0;margin:0;width:200px;height:200px;"></div></span><span id="phonepageyl" onMouseOver="showHide0123(qrcodeyl)" onMouseOut="showHide0123(qrcodeyl)">ÊÖ»ú°æ</span> | <script>var qrcode = new QRCode('qrcodeyl', {
