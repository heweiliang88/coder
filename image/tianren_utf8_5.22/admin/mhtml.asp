...
<table width="100%" align="center" border="0" cellpadding="3" cellspacing="1" id="mytable" class="size3" >
	<tr class="tr1" >
		<td class="td_title" colspan="4">■ 手机版静态化管理 &nbsp;&nbsp;| <a href="site_set.asp" target="_self"  style="color:#00F;">切换为动态版</a> | <a href="site_set.asp" target="_self" style="color:#00F;">切换为静态版</a> | <a href="site_set.asp" target="_self" style="color:#00F;">切换为伪静态版</a></td>
	</tr>
	<%if application(siternd & "55trmurltype")<>2 then%>
	<tr colspan="4">
		<td> 当前手机版网站状态不是静态版，无法生成静态，请到 "站点设置-- 手机版动态、静态、伪静态"中切换为静态，<a href="site_set.asp" target="_self" style="color:#ff0000;">点此直达切换为手机静态版</a></td>
	</tr>
	<%else%>
	<tr class="font1">
	...
	<tr class="">
		<form name="form1" id="form1" action="mhtmlsave.asp" target="ifr1" method="post" onSubmit="" >
	...
	<form name="form2" id="form2" action="mhtmlsave.asp" target="ifr2" method="post" onSubmit="" >
		<tr class="">
	...
	<form name="form2" id="form2" action="mhtmlsave.asp" target="ifr3" method="post" onSubmit="" >
		<tr class="">
